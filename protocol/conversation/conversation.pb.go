// Copyright © 2023 rocim. All rights reserved.
//
...
type ConversationReq struct {
	...
	RecvMsgOpt       int32                  `protobuf:"varint,5,opt,name=recvMsgOpt,proto3" json:"recvMsgOpt,omitempty"`
	IsPinned         bool                   `protobuf:"varint,6,opt,name=isPinned,proto3" json:"isPinned,omitempty"`
	AttachedInfo     string                 `protobuf:"bytes,7,opt,name=attachedInfo,proto3" json:"attachedInfo,omitempty"`
	IsPrivateChat    bool                   `protobuf:"varint,8,opt,name=isPrivateChat,proto3" json:"isPrivateChat,omitempty"`
	Ex               string                 `protobuf:"bytes,9,opt,name=ex,proto3" json:"ex,omitempty"`
	BurnDuration     int32                  `protobuf:"varint,10,opt,name=burnDuration,proto3" json:"burnDuration,omitempty"`
	MinSeq           int64                  `protobuf:"varint,11,opt,name=minSeq,proto3" json:"minSeq,omitempty"`
	MaxSeq           int64                  `protobuf:"varint,12,opt,name=maxSeq,proto3" json:"maxSeq,omitempty"`
	GroupAtType      int32                  `protobuf:"varint,13,opt,name=groupAtType,proto3" json:"groupAtType,omitempty"`
	MsgDestructTime  int64                  `protobuf:"varint,14,opt,name=msgDestructTime,proto3" json:"msgDestructTime,omitempty"`
	IsMsgDestruct    bool                   `protobuf:"varint,15,opt,name=isMsgDestruct,proto3" json:"isMsgDestruct,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
type UpdateConversationReq struct {
	...
	RecvMsgOpt            int32                  `protobuf:"varint,3,opt,name=recvMsgOpt,proto3" json:"recvMsgOpt,omitempty"`
	IsPinned              bool                   `protobuf:"varint,4,opt,name=isPinned,proto3" json:"isPinned,omitempty"`
	AttachedInfo          string                 `protobuf:"bytes,5,opt,name=attachedInfo,proto3" json:"attachedInfo,omitempty"`
	IsPrivateChat         bool                   `protobuf:"varint,6,opt,name=isPrivateChat,proto3" json:"isPrivateChat,omitempty"`
	Ex                    string                 `protobuf:"bytes,7,opt,name=ex,proto3" json:"ex,omitempty"`
	BurnDuration          int32                  `protobuf:"varint,8,opt,name=burnDuration,proto3" json:"burnDuration,omitempty"`
	MinSeq                int64                  `protobuf:"varint,9,opt,name=minSeq,proto3" json:"minSeq,omitempty"`
	MaxSeq                int64                  `protobuf:"varint,10,opt,name=maxSeq,proto3" json:"maxSeq,omitempty"`
	GroupAtType           int32                  `protobuf:"varint,11,opt,name=groupAtType,proto3" json:"groupAtType,omitempty"`
	MsgDestructTime       int64                  `protobuf:"varint,12,opt,name=msgDestructTime,proto3" json:"msgDestructTime,omitempty"`
	IsMsgDestruct         bool                   `protobuf:"varint,13,opt,name=isMsgDestruct,proto3" json:"isMsgDestruct,omitempty"`
	LatestMsgDestructTime int64                  `protobuf:"varint,14,opt,name=latestMsgDestructTime,proto3" json:"latestMsgDestructTime,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
const file_conversation_conversation_proto_rawDesc = "" +
	"\n" +
	"\x1fconversation/conversation.proto\x12\x12rocim.conversation\x1a\x11sdkws/sdkws.proto\"\xc8\x04\n" +
	"\fConversation\x12 \n" +
	...
	"\risMsgDestruct\x18\x11 \x01(\bR\risMsgDestruct\"\xf3\x03\n" +
	...
	"\agroupID\x18\x04 \x01(\tR\agroupID\x12\x1e\n" +
	"\n" +
	"recvMsgOpt\x18\x05 \x01(\x05R\n" +
	"recvMsgOpt\x12\x1a\n" +
	"\bisPinned\x18\x06 \x01(\bR\bisPinned\x12\"\n" +
	"\fattachedInfo\x18\a \x01(\tR\fattachedInfo\x12$\n" +
	"\risPrivateChat\x18\b \x01(\bR\risPrivateChat\x12\x0e\n" +
	"\x02ex\x18\t \x01(\tR\x02ex\x12\"\n" +
	"\fburnDuration\x18\n" +
	" \x01(\x05R\fburnDuration\x12\x16\n" +
	"\x06minSeq\x18\v \x01(\x03R\x06minSeq\x12\x16\n" +
	"\x06maxSeq\x18\f \x01(\x03R\x06maxSeq\x12 \n" +
	"\vgroupAtType\x18\r \x01(\x05R\vgroupAtType\x12(\n" +
	"\x0fmsgDestructTime\x18\x0e \x01(\x03R\x0fmsgDestructTime\x12$\n" +
	"\risMsgDestruct\x18\x0f \x01(\bR\risMsgDestruct\"Z\n" +
	"\x12SetConversationReq\x12D\n" +
	"\fconversation\x18\x01 \x01(\v2 .rocim.conversation.ConversationR\fconversation\"\x15\n" +
	"\x13SetConversationResp\"^\n" +
	"\x12GetConversationReq\x12&\n" +
	"\x0econversationID\x18\x01 \x01(\tR\x0econversationID\x12 \n" +
	"\vownerUserID\x18\x02 \x01(\tR\vownerUserID\"[\n" +
	"\x13GetConversationResp\x12D\n" +
	"\fconversation\x18\x02 \x01(\v2 .rocim.conversation.ConversationR\fconversation\"\xa0\x01\n" +
	"\x1cGetSortedConversationListReq\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\x12(\n" +
	"\x0fconversationIDs\x18\x02 \x03(\tR\x0fconversationIDs\x12>\n" +
	"\n" +
	"pagination\x18\x03 \x01(\v2\x1e.rocim.sdkws.RequestPaginationR\n" +
	"pagination\"\xc3\x01\n" +
	"\x1dGetSortedConversationListResp\x12,\n" +
	"\x11conversationTotal\x18\x01 \x01(\x03R\x11conversationTotal\x12 \n" +
	"\vunreadTotal\x18\x02 \x01(\x03R\vunreadTotal\x12R\n" +
	"\x11conversationElems\x18\x03 \x03(\v2$.rocim.conversation.ConversationElemR\x11conversationElems\"\xcf\x01\n" +
	...
	"\bIsPinned\x18\x04 \x01(\bR\bIsPinned\x125\n" +
	"\amsgInfo\x18\x05 \x01(\v2\x1b.rocim.conversation.MsgInfoR\amsgInfo\"\x93\x04\n" +
	"\aMsgInfo\x12 \n" +
	...
	"\x14GetConversationsResp\x12F\n" +
	"\rconversations\x18\x02 \x03(\v2 .rocim.conversation.ConversationR\rconversations\":\n" +
	"\x16GetAllConversationsReq\x12 \n" +
	"\vownerUserID\x18\x01 \x01(\tR\vownerUserID\"a\n" +
	"\x17GetAllConversationsResp\x12F\n" +
	"\rconversations\x18\x02 \x03(\v2 .rocim.conversation.ConversationR\rconversations\"9\n" +
	...
	"\x0fconversationIDs\x18\x01 \x03(\tR\x0fconversationIDs\"x\n" +
	"\x13SetConversationsReq\x12\x18\n" +
	"\auserIDs\x18\x01 \x03(\tR\auserIDs\x12G\n" +
	"\fconversation\x18\x02 \x01(\v2#.rocim.conversation.ConversationReqR\fconversation\"\x16\n" +
	...
	"\x0fconversationIDs\x18\x01 \x03(\tR\x0fconversationIDs\"n\n" +
	"$GetConversationsByConversationIDResp\x12F\n" +
	"\rconversations\x18\x01 \x03(\v2 .rocim.conversation.ConversationR\rconversations\"h\n" +
	...
	"\auserIDs\x18\x01 \x03(\tR\auserIDs\"\xeb\x03\n" +
	"\x15UpdateConversationReq\x12&\n" +
	"\x0econversationID\x18\x01 \x01(\tR\x0econversationID\x12\x18\n" +
	"\auserIDs\x18\x02 \x03(\tR\auserIDs\x12\x1e\n" +
	"\n" +
	"recvMsgOpt\x18\x03 \x01(\x05R\n" +
	"recvMsgOpt\x12\x1a\n" +
	"\bisPinned\x18\x04 \x01(\bR\bisPinned\x12\"\n" +
	"\fattachedInfo\x18\x05 \x01(\tR\fattachedInfo\x12$\n" +
	"\risPrivateChat\x18\x06 \x01(\bR\risPrivateChat\x12\x0e\n" +
	"\x02ex\x18\a \x01(\tR\x02ex\x12\"\n" +
	"\fburnDuration\x18\b \x01(\x05R\fburnDuration\x12\x16\n" +
	"\x06minSeq\x18\t \x01(\x03R\x06minSeq\x12\x16\n" +
	"\x06maxSeq\x18\n" +
	" \x01(\x03R\x06maxSeq\x12 \n" +
	"\vgroupAtType\x18\v \x01(\x05R\vgroupAtType\x12(\n" +
	"\x0fmsgDestructTime\x18\f \x01(\x03R\x0fmsgDestructTime\x12$\n" +
	"\risMsgDestruct\x18\r \x01(\bR\risMsgDestruct\x124\n" +
	"\x15latestMsgDestructTime\x18\x0e \x01(\x03R\x15latestMsgDestructTime\"\x18\n" +
	...
	"\aversion\x18\x03 \x01(\x04R\aversion\"\xf8\x01\n" +
	"\x1eGetIncrementalConversationResp\x12\x18\n" +
	"\aversion\x18\x01 \x01(\x04R\aversion\x12\x1c\n" +
	"\tversionID\x18\x02 \x01(\tR\tversionID\x12\x12\n" +
	"\x04full\x18\x03 \x01(\bR\x04full\x12\x16\n" +
	"\x06delete\x18\x04 \x03(\tR\x06delete\x128\n" +
	"\x06insert\x18\x05 \x03(\v2 .rocim.conversation.ConversationR\x06insert\x128\n" +
	"\x06update\x18\x06 \x03(\v2 .rocim.conversation.ConversationR\x06update\"q\n" +
	"\x17GetOwnerConversationReq\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\x12>\n" +
	"\n" +
	"pagination\x18\x02 \x01(\v2\x1e.rocim.sdkws.RequestPaginationR\n" +
	"pagination\"x\n" +
	"\x18GetOwnerConversationResp\x12\x14\n" +
	"\x05total\x18\x01 \x01(\x03R\x05total\x12F\n" +
	"\rconversations\x18\x02 \x03(\v2 .rocim.conversation.ConversationR\rconversations\"!\n" +
	"\x1fGetConversationsNeedClearMsgReq\"j\n" +
	" GetConversationsNeedClearMsgResp\x12F\n" +
	"\rconversations\x18\x01 \x03(\v2 .rocim.conversation.ConversationR\rconversations\"8\n" +
	...
	"\x1dUpdateConversationsByUserResp2\xfc\x18\n" +
	"\fconversation\x12b\n" +
	"\x0fGetConversation\x12&.rocim.conversation.GetConversationReq\x1a'.rocim.conversation.GetConversationResp\x12\x80\x01\n" +
	"\x19GetSortedConversationList\x120.rocim.conversation.GetSortedConversationListReq\x1a1.rocim.conversation.GetSortedConversationListResp\x12n\n" +
	"\x13GetAllConversations\x12*.rocim.conversation.GetAllConversationsReq\x1a+.rocim.conversation.GetAllConversationsResp\x12e\n" +
	"\x10GetConversations\x12'.rocim.conversation.GetConversationsReq\x1a(.rocim.conversation.GetConversationsResp\x12b\n" +
	"\x0fSetConversation\x12&.rocim.conversation.SetConversationReq\x1a'.rocim.conversation.SetConversationResp\x12\x83\x01\n" +
	"\x1aGetRecvMsgNotNotifyUserIDs\x121.rocim.conversation.GetRecvMsgNotNotifyUserIDsReq\x1a2.rocim.conversation.GetRecvMsgNotNotifyUserIDsResp\x12\x8c\x01\n" +
	"\x1dCreateSingleChatConversations\x124.rocim.conversation.CreateSingleChatConversationsReq\x1a5.rocim.conversation.CreateSingleChatConversationsResp\x12\x89\x01\n" +
	"\x1cCreateGroupChatConversations\x123.rocim.conversation.CreateGroupChatConversationsReq\x1a4.rocim.conversation.CreateGroupChatConversationsResp\x12t\n" +
	"\x15SetConversationMaxSeq\x12,.rocim.conversation.SetConversationMaxSeqReq\x1a-.rocim.conversation.SetConversationMaxSeqResp\x12t\n" +
	"\x15SetConversationMinSeq\x12,.rocim.conversation.SetConversationMinSeqReq\x1a-.rocim.conversation.SetConversationMinSeqResp\x12k\n" +
	"\x12GetConversationIDs\x12).rocim.conversation.GetConversationIDsReq\x1a*.rocim.conversation.GetConversationIDsResp\x12e\n" +
	"\x10SetConversations\x12'.rocim.conversation.SetConversationsReq\x1a(.rocim.conversation.SetConversationsResp\x12\x83\x01\n" +
	"\x1aGetUserConversationIDsHash\x121.rocim.conversation.GetUserConversationIDsHashReq\x1a2.rocim.conversation.GetUserConversationIDsHashResp\x12\x95\x01\n" +
	" GetConversationsByConversationID\x127.rocim.conversation.GetConversationsByConversationIDReq\x1a8.rocim.conversation.GetConversationsByConversationIDResp\x12\x98\x01\n" +
	"!GetConversationOfflinePushUserIDs\x128.rocim.conversation.GetConversationOfflinePushUserIDsReq\x1a9.rocim.conversation.GetConversationOfflinePushUserIDsResp\x12\xaa\x01\n" +
	"'GetConversationNotReceiveMessageUserIDs\x12>.rocim.conversation.GetConversationNotReceiveMessageUserIDsReq\x1a?.rocim.conversation.GetConversationNotReceiveMessageUserIDsResp\x12k\n" +
	"\x12UpdateConversation\x12).rocim.conversation.UpdateConversationReq\x1a*.rocim.conversation.UpdateConversationResp\x12\x86\x01\n" +
	"\x1bGetFullOwnerConversationIDs\x122.rocim.conversation.GetFullOwnerConversationIDsReq\x1a3.rocim.conversation.GetFullOwnerConversationIDsResp\x12\x83\x01\n" +
	"\x1aGetIncrementalConversation\x121.rocim.conversation.GetIncrementalConversationReq\x1a2.rocim.conversation.GetIncrementalConversationResp\x12q\n" +
	"\x14GetOwnerConversation\x12+.rocim.conversation.GetOwnerConversationReq\x1a,.rocim.conversation.GetOwnerConversationResp\x12\x89\x01\n" +
	"\x1cGetConversationsNeedClearMsg\x123.rocim.conversation.GetConversationsNeedClearMsgReq\x1a4.rocim.conversation.GetConversationsNeedClearMsgResp\x12\x86\x01\n" +
	"\x1bGetNotNotifyConversationIDs\x122.rocim.conversation.GetNotNotifyConversationIDsReq\x1a3.rocim.conversation.GetNotNotifyConversationIDsResp\x12}\n" +
	"\x18GetPinnedConversationIDs\x12/.rocim.conversation.GetPinnedConversationIDsReq\x1a0.rocim.conversation.GetPinnedConversationIDsResp\x12}\n" +
	"\x18ClearUserConversationMsg\x12/.rocim.conversation.ClearUserConversationMsgReq\x1a0.rocim.conversation.ClearUserConversationMsgResp\x12\x80\x01\n" +
	"\x19UpdateConversationsByUser\x120.rocim.conversation.UpdateConversationsByUserReq\x1a1.rocim.conversation.UpdateConversationsByUserRespB4Z2github.com/roc/roc-im-server/protocol/conversationb\x06proto3"
...
var file_conversation_conversation_proto_goTypes = []any{
	(*Conversation)(nil),                                // 0: rocim.conversation.Conversation
	(*ConversationReq)(nil),                             // 1: rocim.conversation.ConversationReq
	(*SetConversationReq)(nil),                          // 2: rocim.conversation.SetConversationReq
	(*SetConversationResp)(nil),                         // 3: rocim.conversation.SetConversationResp
	(*GetConversationReq)(nil),                          // 4: rocim.conversation.GetConversationReq
	(*GetConversationResp)(nil),                         // 5: rocim.conversation.GetConversationResp
	(*GetSortedConversationListReq)(nil),                // 6: rocim.conversation.GetSortedConversationListReq
	(*GetSortedConversationListResp)(nil),               // 7: rocim.conversation.GetSortedConversationListResp
	(*ConversationElem)(nil),                            // 8: rocim.conversation.ConversationElem
	(*MsgInfo)(nil),                                     // 9: rocim.conversation.MsgInfo
	(*GetConversationsReq)(nil),                         // 10: rocim.conversation.GetConversationsReq
	(*GetConversationsResp)(nil),                        // 11: rocim.conversation.GetConversationsResp
	(*GetAllConversationsReq)(nil),                      // 12: rocim.conversation.GetAllConversationsReq
	(*GetAllConversationsResp)(nil),                     // 13: rocim.conversation.GetAllConversationsResp
	(*GetRecvMsgNotNotifyUserIDsReq)(nil),               // 14: rocim.conversation.GetRecvMsgNotNotifyUserIDsReq
	(*GetRecvMsgNotNotifyUserIDsResp)(nil),              // 15: rocim.conversation.GetRecvMsgNotNotifyUserIDsResp
	(*CreateSingleChatConversationsReq)(nil),            // 16: rocim.conversation.CreateSingleChatConversationsReq
	(*CreateSingleChatConversationsResp)(nil),           // 17: rocim.conversation.CreateSingleChatConversationsResp
	(*CreateGroupChatConversationsReq)(nil),             // 18: rocim.conversation.CreateGroupChatConversationsReq
	(*CreateGroupChatConversationsResp)(nil),            // 19: rocim.conversation.CreateGroupChatConversationsResp
	(*SetConversationMaxSeqReq)(nil),                    // 20: rocim.conversation.SetConversationMaxSeqReq
	(*SetConversationMaxSeqResp)(nil),                   // 21: rocim.conversation.SetConversationMaxSeqResp
	(*SetConversationMinSeqReq)(nil),                    // 22: rocim.conversation.SetConversationMinSeqReq
	(*SetConversationMinSeqResp)(nil),                   // 23: rocim.conversation.SetConversationMinSeqResp
	(*GetConversationIDsReq)(nil),                       // 24: rocim.conversation.GetConversationIDsReq
	(*GetConversationIDsResp)(nil),                      // 25: rocim.conversation.GetConversationIDsResp
	(*SetConversationsReq)(nil),                         // 26: rocim.conversation.SetConversationsReq
	(*SetConversationsResp)(nil),                        // 27: rocim.conversation.SetConversationsResp
	(*GetUserConversationIDsHashReq)(nil),               // 28: rocim.conversation.GetUserConversationIDsHashReq
	(*GetUserConversationIDsHashResp)(nil),              // 29: rocim.conversation.GetUserConversationIDsHashResp
	(*GetConversationsByConversationIDReq)(nil),         // 30: rocim.conversation.GetConversationsByConversationIDReq
	(*GetConversationsByConversationIDResp)(nil),        // 31: rocim.conversation.GetConversationsByConversationIDResp
	(*GetConversationOfflinePushUserIDsReq)(nil),        // 32: rocim.conversation.GetConversationOfflinePushUserIDsReq
	(*GetConversationOfflinePushUserIDsResp)(nil),       // 33: rocim.conversation.GetConversationOfflinePushUserIDsResp
	(*GetConversationNotReceiveMessageUserIDsReq)(nil),  // 34: rocim.conversation.GetConversationNotReceiveMessageUserIDsReq
	(*GetConversationNotReceiveMessageUserIDsResp)(nil), // 35: rocim.conversation.GetConversationNotReceiveMessageUserIDsResp
	(*UpdateConversationReq)(nil),                       // 36: rocim.conversation.UpdateConversationReq
	(*UpdateConversationResp)(nil),                      // 37: rocim.conversation.UpdateConversationResp
	(*GetFullOwnerConversationIDsReq)(nil),              // 38: rocim.conversation.GetFullOwnerConversationIDsReq
	(*GetFullOwnerConversationIDsResp)(nil),             // 39: rocim.conversation.GetFullOwnerConversationIDsResp
	(*GetIncrementalConversationReq)(nil),               // 40: rocim.conversation.GetIncrementalConversationReq
	(*GetIncrementalConversationResp)(nil),              // 41: rocim.conversation.GetIncrementalConversationResp
	(*GetOwnerConversationReq)(nil),                     // 42: rocim.conversation.GetOwnerConversationReq
	(*GetOwnerConversationResp)(nil),                    // 43: rocim.conversation.GetOwnerConversationResp
	(*GetConversationsNeedClearMsgReq)(nil),             // 44: rocim.conversation.GetConversationsNeedClearMsgReq
	(*GetConversationsNeedClearMsgResp)(nil),            // 45: rocim.conversation.GetConversationsNeedClearMsgResp
	(*GetNotNotifyConversationIDsReq)(nil),              // 46: rocim.conversation.GetNotNotifyConversationIDsReq
	(*GetNotNotifyConversationIDsResp)(nil),             // 47: rocim.conversation.GetNotNotifyConversationIDsResp
	(*GetPinnedConversationIDsReq)(nil),                 // 48: rocim.conversation.GetPinnedConversationIDsReq
	(*GetPinnedConversationIDsResp)(nil),                // 49: rocim.conversation.GetPinnedConversationIDsResp
	(*ClearUserConversationMsgReq)(nil),                 // 50: rocim.conversation.ClearUserConversationMsgReq
	(*ClearUserConversationMsgResp)(nil),                // 51: rocim.conversation.ClearUserConversationMsgResp
	(*UpdateConversationsByUserReq)(nil),                // 52: rocim.conversation.UpdateConversationsByUserReq
	(*UpdateConversationsByUserResp)(nil),               // 53: rocim.conversation.UpdateConversationsByUserResp
	(*sdkws.RequestPagination)(nil),                     // 54: rocim.sdkws.RequestPagination
}
var file_conversation_conversation_proto_depIdxs = []int32{
	0,  // 0: rocim.conversation.SetConversationReq.conversation:type_name -> rocim.conversation.Conversation
	0,  // 1: rocim.conversation.GetConversationResp.conversation:type_name -> rocim.conversation.Conversation
	54, // 2: rocim.conversation.GetSortedConversationListReq.pagination:type_name -> rocim.sdkws.RequestPagination
	8,  // 3: rocim.conversation.GetSortedConversationListResp.conversationElems:type_name -> rocim.conversation.ConversationElem
	9,  // 4: rocim.conversation.ConversationElem.msgInfo:type_name -> rocim.conversation.MsgInfo
	0,  // 5: rocim.conversation.GetConversationsResp.conversations:type_name -> rocim.conversation.Conversation
	0,  // 6: rocim.conversation.GetAllConversationsResp.conversations:type_name -> rocim.conversation.Conversation
	1,  // 7: rocim.conversation.SetConversationsReq.conversation:type_name -> rocim.conversation.ConversationReq
	0,  // 8: rocim.conversation.GetConversationsByConversationIDResp.conversations:type_name -> rocim.conversation.Conversation
	0,  // 9: rocim.conversation.GetIncrementalConversationResp.insert:type_name -> rocim.conversation.Conversation
	0,  // 10: rocim.conversation.GetIncrementalConversationResp.update:type_name -> rocim.conversation.Conversation
	54, // 11: rocim.conversation.GetOwnerConversationReq.pagination:type_name -> rocim.sdkws.RequestPagination
	0,  // 12: rocim.conversation.GetOwnerConversationResp.conversations:type_name -> rocim.conversation.Conversation
	0,  // 13: rocim.conversation.GetConversationsNeedClearMsgResp.conversations:type_name -> rocim.conversation.Conversation
	4,  // 14: rocim.conversation.conversation.GetConversation:input_type -> rocim.conversation.GetConversationReq
	6,  // 15: rocim.conversation.conversation.GetSortedConversationList:input_type -> rocim.conversation.GetSortedConversationListReq
	12, // 16: rocim.conversation.conversation.GetAllConversations:input_type -> rocim.conversation.GetAllConversationsReq
	10, // 17: rocim.conversation.conversation.GetConversations:input_type -> rocim.conversation.GetConversationsReq
	2,  // 18: rocim.conversation.conversation.SetConversation:input_type -> rocim.conversation.SetConversationReq
	14, // 19: rocim.conversation.conversation.GetRecvMsgNotNotifyUserIDs:input_type -> rocim.conversation.GetRecvMsgNotNotifyUserIDsReq
	16, // 20: rocim.conversation.conversation.CreateSingleChatConversations:input_type -> rocim.conversation.CreateSingleChatConversationsReq
	18, // 21: rocim.conversation.conversation.CreateGroupChatConversations:input_type -> rocim.conversation.CreateGroupChatConversationsReq
	20, // 22: rocim.conversation.conversation.SetConversationMaxSeq:input_type -> rocim.conversation.SetConversationMaxSeqReq
	22, // 23: rocim.conversation.conversation.SetConversationMinSeq:input_type -> rocim.conversation.SetConversationMinSeqReq
	24, // 24: rocim.conversation.conversation.GetConversationIDs:input_type -> rocim.conversation.GetConversationIDsReq
	26, // 25: rocim.conversation.conversation.SetConversations:input_type -> rocim.conversation.SetConversationsReq
	28, // 26: rocim.conversation.conversation.GetUserConversationIDsHash:input_type -> rocim.conversation.GetUserConversationIDsHashReq
	30, // 27: rocim.conversation.conversation.GetConversationsByConversationID:input_type -> rocim.conversation.GetConversationsByConversationIDReq
	32, // 28: rocim.conversation.conversation.GetConversationOfflinePushUserIDs:input_type -> rocim.conversation.GetConversationOfflinePushUserIDsReq
	34, // 29: rocim.conversation.conversation.GetConversationNotReceiveMessageUserIDs:input_type -> rocim.conversation.GetConversationNotReceiveMessageUserIDsReq
	36, // 30: rocim.conversation.conversation.UpdateConversation:input_type -> rocim.conversation.UpdateConversationReq
	38, // 31: rocim.conversation.conversation.GetFullOwnerConversationIDs:input_type -> rocim.conversation.GetFullOwnerConversationIDsReq
	40, // 32: rocim.conversation.conversation.GetIncrementalConversation:input_type -> rocim.conversation.GetIncrementalConversationReq
	42, // 33: rocim.conversation.conversation.GetOwnerConversation:input_type -> rocim.conversation.GetOwnerConversationReq
	44, // 34: rocim.conversation.conversation.GetConversationsNeedClearMsg:input_type -> rocim.conversation.GetConversationsNeedClearMsgReq
	46, // 35: rocim.conversation.conversation.GetNotNotifyConversationIDs:input_type -> rocim.conversation.GetNotNotifyConversationIDsReq
	48, // 36: rocim.conversation.conversation.GetPinnedConversationIDs:input_type -> rocim.conversation.GetPinnedConversationIDsReq
	50, // 37: rocim.conversation.conversation.ClearUserConversationMsg:input_type -> rocim.conversation.ClearUserConversationMsgReq
	52, // 38: rocim.conversation.conversation.UpdateConversationsByUser:input_type -> rocim.conversation.UpdateConversationsByUserReq
	5,  // 39: rocim.conversation.conversation.GetConversation:output_type -> rocim.conversation.GetConversationResp
	7,  // 40: rocim.conversation.conversation.GetSortedConversationList:output_type -> rocim.conversation.GetSortedConversationListResp
	13, // 41: rocim.conversation.conversation.GetAllConversations:output_type -> rocim.conversation.GetAllConversationsResp
	11, // 42: rocim.conversation.conversation.GetConversations:output_type -> rocim.conversation.GetConversationsResp
	3,  // 43: rocim.conversation.conversation.SetConversation:output_type -> rocim.conversation.SetConversationResp
	15, // 44: rocim.conversation.conversation.GetRecvMsgNotNotifyUserIDs:output_type -> rocim.conversation.GetRecvMsgNotNotifyUserIDsResp
	17, // 45: rocim.conversation.conversation.CreateSingleChatConversations:output_type -> rocim.conversation.CreateSingleChatConversationsResp
	19, // 46: rocim.conversation.conversation.CreateGroupChatConversations:output_type -> rocim.conversation.CreateGroupChatConversationsResp
	21, // 47: rocim.conversation.conversation.SetConversationMaxSeq:output_type -> rocim.conversation.SetConversationMaxSeqResp
	23, // 48: rocim.conversation.conversation.SetConversationMinSeq:output_type -> rocim.conversation.SetConversationMinSeqResp
	25, // 49: rocim.conversation.conversation.GetConversationIDs:output_type -> rocim.conversation.GetConversationIDsResp
	27, // 50: rocim.conversation.conversation.SetConversations:output_type -> rocim.conversation.SetConversationsResp
	29, // 51: rocim.conversation.conversation.GetUserConversationIDsHash:output_type -> rocim.conversation.GetUserConversationIDsHashResp
	31, // 52: rocim.conversation.conversation.GetConversationsByConversationID:output_type -> rocim.conversation.GetConversationsByConversationIDResp
	33, // 53: rocim.conversation.conversation.GetConversationOfflinePushUserIDs:output_type -> rocim.conversation.GetConversationOfflinePushUserIDsResp
	35, // 54: rocim.conversation.conversation.GetConversationNotReceiveMessageUserIDs:output_type -> rocim.conversation.GetConversationNotReceiveMessageUserIDsResp
	37, // 55: rocim.conversation.conversation.UpdateConversation:output_type -> rocim.conversation.UpdateConversationResp
	39, // 56: rocim.conversation.conversation.GetFullOwnerConversationIDs:output_type -> rocim.conversation.GetFullOwnerConversationIDsResp
	41, // 57: rocim.conversation.conversation.GetIncrementalConversation:output_type -> rocim.conversation.GetIncrementalConversationResp
	43, // 58: rocim.conversation.conversation.GetOwnerConversation:output_type -> rocim.conversation.GetOwnerConversationResp
	45, // 59: rocim.conversation.conversation.GetConversationsNeedClearMsg:output_type -> rocim.conversation.GetConversationsNeedClearMsgResp
	47, // 60: rocim.conversation.conversation.GetNotNotifyConversationIDs:output_type -> rocim.conversation.GetNotNotifyConversationIDsResp
	49, // 61: rocim.conversation.conversation.GetPinnedConversationIDs:output_type -> rocim.conversation.GetPinnedConversationIDsResp
	51, // 62: rocim.conversation.conversation.ClearUserConversationMsg:output_type -> rocim.conversation.ClearUserConversationMsgResp
	53, // 63: rocim.conversation.conversation.UpdateConversationsByUser:output_type -> rocim.conversation.UpdateConversationsByUserResp
