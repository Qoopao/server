...
import (
	...
	mongodb_example "github.com/roc/roc-im-server/examples/mongodb_example"
)
...
func Test_main() {
	...
	// 	fmt.Println("  mongodb            - MongoDB数据库示例")
	// 	return
	// }
	...
	// case "mongodb":
	// 	fmt.Println("运行MongoDB数据库示例...")
	// 	mongodb_example.MongoDBExample_main()
	// default:
